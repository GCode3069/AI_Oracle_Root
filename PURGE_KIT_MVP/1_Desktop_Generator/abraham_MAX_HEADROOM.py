...
def generate_script(headline):
    """Generate ROAST-STYLE comedy in successful WARNING format - SHORT & PUNCHY"""
    # Match the successful format: Short, punchy, roast style (like Dolemite/Chappelle/Foxx)
    hl = headline.lower()
...
When I was alive, we had SHERIFFS. Now you got NOTHING!

This is INSANITY! Who's gonna stop the criminals? The criminals?!

I died believing in justice. I was WRONG!
...
Education used to matter. Now it's a JOKE!

Teachers quitting. Kids failing. Parents crying!

I died for progress. This ain't progress—this is REGRESSION!

Bitcoin {BITCOIN_ADDRESS}"""
    
    elif "military" in hl or "draft" in hl:
        topic = "Military Draft Activated"
        return f"""Abraham Lincoln! Commander in Chief! Still WARNING you!

{headline}.

AMERICA! Draft? Again?! You didn't learn from VIETNAM?!

I fought a war for UNITY. You're starting wars for PROFIT!

Young men dying. Old men deciding. SAME OLD STORY!

Wake up! This draft ain't for FREEDOM—it's for CONTROL!

I died for this country. Don't make MORE die for GREED!
...
def create_max_headroom_video(lincoln_image, audio_path, output_path, headline, use_lipsync=True, use_jumpscare=True):
    """Create Max Headroom-style glitchy TV broadcast - BEAUTIFULLY SYNCED"""
    print("[Video] Creating Max Headroom glitchy TV effect (synced)...")
