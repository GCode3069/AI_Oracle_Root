# SCARIFY + ABRAHAM LINCOLN - SELF-CONTAINED BOOTSTRAP
...
Write-Host ""
Write-Host "ABRAHAM LINCOLN COMEDY GENERATOR - BOOTSTRAP" -ForegroundColor Red
...
$pyFile = Join-Path $ROOT "abe_comedy.py"
...
$vids = Get-ChildItem (Join-Path $ROOT "uploaded") -Filter "ABE_*.mp4" -ErrorAction SilentlyContinue
if ($vids) {
